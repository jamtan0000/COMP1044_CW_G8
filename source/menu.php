	...
	<form method="POST">
		<div class="wrapper">
			...
			<div class="logo"><a href="#">Library Menu</a></div>
				...
				<li>
					<input id="destroy" formaction="destroy.php" value="Log Out" type="submit" onclick="return logOut()">
				</li>
			</div>
			</nav>
		</div>
	</form>
		<div class="dummy-text" background-color="#0f2952, #3c6a8f)">
			<h2>Welcome to the Library</h2>
			&nbsp;
			<h2>Read a Book</h2>
			&nbsp;
			<h2>Be an Avid Reader Today</h2>
		</div>
	</body>
